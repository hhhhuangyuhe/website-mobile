  ...
  <div id="aboutUs">
    ...
    <div class="b-one" v-if="active == 0">
      <div class="datas">
        <div class="data-item">
          ...
          <p class="title">服务大中型企业</p>
        </div>
        <div class="data-item">
          <p class="val">
            200
            <span class="word">万</span>
            <span class="p_f">+</span>
          </p>
          <p class="title">服务员工人数</p>
        </div>
        <div class="data-item">
          <p class="val">
            300
        ...
        <div class="data-item">
          ...
          <p class="title">人力资源外包服务经验</p>
        </div>
      </div>
      <div class="long-words">
        <p class="row">泛员网是泛睿企服旗下企业雇员服务平台，也是国内首家针对大中型企业的在线人力资源外包服务平台。</p>
        <p
          class="row"
        >目前泛员网在线人力资源外包服务平台提供的服务项目有：智能入职与员工关系管理、全国社保外包服务、薪资智能核算与代发服务、考勤与休假管理、全国员工体检、企业商业保险、节日福利、弹性福利等。</p>
        <p
          class="row"
        >相较于传统人力资源外包服务方式，泛员网在线人力资源外包服务平台具有：在线交互、流程可视、数据报表、实时提醒、客服中心及时应答员工咨询、随时随地查询数据等特点。</p>
        <p
          class="row"
        >泛员网继承了泛睿企服16年的人力资源外包服务经验，共享了泛睿企服全国52+分公司和300+城市服务网络的落地服务和运营经验，采用全新的“在线HR共享服务平台+前后台分离的客服服务团队+全国落地执行网点”的服务模式，大幅度提高了人力资源服务流程效率、数据准确率、企业客户服务体检和员工满意度。</p>
      </div>
    </div>
    ...
    <div class="b-three" v-if="active == 2">
      ...
      <div class="contactus">
        ...
        <p class="group">集团总部</p>
        <div class="group-detail">
          <img src="../assets/img/aboutus/定位.png" class="location" />
          <p>深圳市福田区新洲十一街祥祺大厦19层</p>
        </div>
...
.b-one .datas .data-item .val {
  font-size: 48px;
  font-family: Bebas;
  font-weight: 400;
  color: rgba(0, 0, 0, 1);
}
.b-one .datas .data-item .title {
  font-size: 24px;
  font-weight: 400;
  color: rgba(0, 0, 0, 1);
  line-height: 23px;
}
.b-one .datas .data-item .word {
  font-size: 24px;
  font-family: "思源黑体";
  font-weight: bold;
  color: rgba(0, 0, 0, 1);
...
.b-one .long-words {
  ...
  font-size: 24px;
  font-weight: 400;
  color: rgba(48, 59, 75, 1);
}
.b-one .long-words .row {
  text-indent: 48px;
  line-height: 40px;
  margin-bottom: 50px;
}
...
.b-two .save .save-item {
  padding: 50px 60px;
  display: flex;
}
.b-two .save .save-item .save-icon {
  width: 160px;
  height: 184px;
  margin-right: 50px;
}
.b-two .save .save-item .save-item-title {
  font-size: 30px;
  font-weight: 400;
  color: rgba(0, 0, 0, 1);
  line-height: 29px;
...
.b-two .save .save-item ul {
  font-size: 24px;
  line-height: 28px;
  font-weight: 400;
  color: rgba(102, 102, 102, 1);
}
.b-two .save .save-item ul li::before {
  content: "";
...
.b-three .contactus .special-title {
  width: 243px;
  margin-bottom: 79px;
}
.b-three .contactus .data {
  font-size: 24px;
...
.b-three .contactus .data .big-data {
  font-size: 40px;
  font-family: "思源黑体M";
}
.b-three .contactus .break-line {
  display: block;
  width: 40px;
  height: 4px;
  background: rgba(255, 78, 58, 1);
  margin-bottom: 39px;
}
.b-three .group {
  font-size: 30px;
...
.b-three .group-detail .location {
  width: 30px;
  margin-right: 29px;
}
.b-three .group-detail .phone {
  width: 30px;
  margin-right: 29px;
}
.b-three .group-detail.last {
  align-items: flex-start;
  margin-top: 30px;
}
.b-three .group-detail.last p {
  line-height: 30px;
}
</style>