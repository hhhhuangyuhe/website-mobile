    ...
    <div class="bookingBox">
        ...
        <div class="book-row scale">
          ...
          <ul class="selector" v-show="showScaleList">
            <li class="select-option" @click="fyw_scale = '100人以下';showScaleList = false;">100人以下</li>
            <li class="select-option" @click="fyw_scale = '100人-500人';showScaleList = false;">100人-500人</li>
            <li class="select-option" @click="fyw_scale = '500人-1000人';showScaleList = false;">500人-1000人</li>
            <li class="select-option" @click="fyw_scale = '1000人-5000人';showScaleList = false;">1000人-5000人</li>
            <li class="select-option" @click="fyw_scale = '5000人以上';showScaleList = false;">5000人以上</li>
          </ul>
        </div>
