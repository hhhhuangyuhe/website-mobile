  ...
  <div id="fyw-fixedBooking">
    ...
    >
      <div class="bookingBox" v-if="showBookingBox">
        ...
        <div class="book-row">
          <div class="input-row">
            <img src="../assets/img/booking/邮件.png" class="frontIcon email" />
            <input
              placeholder="您的企业邮箱"
              class="input-row-val"
              v-model="email"
        ...
        <div class="book-row fixed-scale">
          <div class="input-row" @click="showScaleList = !showScaleList">
            <img
              src="../assets/img/booking/规模指标.png"
              class="frontIcon name"
            />
            <input
              placeholder="选择企业规模"
              class="input-row-val"
        ...
        <div class="book-row fixed-interested">
          <div class="input-row" @click="showInterestList = !showInterestList">
            <img
              src="../assets/img/booking/感兴趣.png"
              class="frontIcon name"
            />
            <input
              placeholder="您感兴趣的内容"
        ...
        <div class="booking-btn book" @click="booking">预约体验</div>
...
export default {
  ...
  methods: {
    ...
    handleClick(event) {
      ...
      let dom2 = document.getElementsByClassName(
        "book-row fixed-interested"
      )[0];
      if (dom2) {
